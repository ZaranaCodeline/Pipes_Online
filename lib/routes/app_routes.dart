...
class SRoutes {
  static final SOnBoardingScreen = '/SOnBoardingScreen';
  ...
  static final SCatelogeHomeScreen = '/SCatelogeHomeScreen';
...
class BRoutes{
  ...
  static final CartPage = '/CartPage';
  static final BReviewScreen = '/BReviewScreen';
