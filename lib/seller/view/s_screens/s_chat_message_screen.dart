...
//   @override
//   void initState() {
//     recieverId = PreferenceManager.getUId();
...
//     print('senderId.getUId()====${PreferenceManager.getUId()}');
//
//     return SafeArea(
//       child: Scaffold(
//         appBar: AppBar(
...
//                       CustomText(
//                         alignment: Alignment.center,
//                         text: widget.isStatus == true ? 'Online' : 'Offline',
//                         fontWeight: FontWeight.w400,
//                         fontSize: 18,
//                         color: widget.isStatus == true
//                             ? Colors.green
//                             : Colors.transparent,
//                       ),
//                     ],
...
//                                                                             MsgDate(
//                                                                           date:
//                                                                               (snapShot.data!.docs[index]['date'] as Timestamp).toDate(),
//                                                                         ),
//                                                                       )
//                                                                     ],
//                                                                   ),
...
//       print('------SEnderwidget.uid----   ${PreferenceManager.getUId()}');
//     } else {
...
//       'senderId': senderId,
//       'receiveId': recieverId,
//       'seen': widget.isStatus != null ? true : false,
//       'msg': _msg,
//       'image': downloadUrl,
//     }).then((value) {
//       print('success add');
