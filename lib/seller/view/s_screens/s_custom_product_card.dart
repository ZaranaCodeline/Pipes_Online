            ...
            return  GridView.builder(
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  Get.to(SSelectedProductScreen(name: snapShot.data!.docs[index]['prdName'],price: snapShot.data!.docs[index]['price'],image: snapShot.data!.docs[index]['imageProfile'],desc: snapShot.data!.docs[index]['dsc'],id: snapShot.data!.docs[index].id,) );
                },
                child: Padding(
