...
class _SLogInHomeScreenState extends State<SLogInHomeScreen> {
  SLogInController sLogInController = Get.put(SLogInController());
  void _submit() async {
    await sLogInController.phoneSignIn(
        phoneNumber: sLogInController.mobileNumber.text);
  }
  @override
