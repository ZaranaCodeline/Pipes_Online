...
class SLogInOTPScreen extends StatefulWidget {
  @override
  _SLogInOTPScreenState createState() => _SLogInOTPScreenState();
}

class _SLogInOTPScreenState extends State<SLogInOTPScreen> {
  ...
  void verifyCode() async {
    ...
    await _auth.signInWithCredential(credential).then((value) {
      print('Seller side...You are logged in successfully');
